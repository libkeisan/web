...
["_api_new","_api_evaluate","_api_free","_free","_memory","___indirect_function_table","_count_plugins","__initialize","onRuntimeInitialized"].forEach((prop) => {
...
function findWasmBinary() {
  ...
  return new URL('libkeisan.wasm', import.meta.url).href;
}
...
var _api_new = Module['_api_new'] = createExportWrapper('api_new', 0);
var _api_evaluate = Module['_api_evaluate'] = createExportWrapper('api_evaluate', 2);
var _api_free = Module['_api_free'] = createExportWrapper('api_free', 1);
